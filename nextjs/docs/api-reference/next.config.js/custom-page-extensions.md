...
Aimed at modules like [@next/mdx](https://github.com/vercel/next.js/tree/main/packages/next-mdx), which adds support for pages ending with `.mdx`. You can configure the extensions looked for in the `pages` directory when resolving pages.
