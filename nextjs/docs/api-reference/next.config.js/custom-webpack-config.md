...
- [preact](https://github.com/vercel/next.js/tree/main/examples/using-preact)
- [Customizing babel configuration](/docs/advanced-features/customizing-babel-config.md)

Some commonly asked for features are available as plugins:

- [@next/mdx](https://github.com/vercel/next.js/tree/main/packages/next-mdx)
- [@next/bundle-analyzer](https://github.com/vercel/next.js/tree/main/packages/next-bundle-analyzer)
...
// https://github.com/vercel/next.js/tree/main/packages/next-mdx
module.exports = {
