...
This is one case. All the cases that are transformed (and tested) can be found in the [`__testfixtures__` directory](https://github.com/vercel/next.js/tree/main/packages/next-codemod/transforms/__testfixtures__/url-to-withrouter).
