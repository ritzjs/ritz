...
<details>
  ...
  <p>Yes! Here's an <a href="https://github.com/vercel/next.js/tree/main/examples/with-apollo">example with Apollo</a>.</p>
</details>

<details>
  <summary>Can I use it with Redux?</summary>
  <p>Yes! Here's an <a href="https://github.com/vercel/next.js/tree/main/examples/with-redux">example</a>. And there's another <a href="https://github.com/vercel/next.js/tree/main/examples/with-redux-thunk">example with thunk</a>.</p>
</details>
...
<details>
  ...
  <p>Since our first release we've had many example contributions. You can check them out in the <a href="https://github.com/vercel/next.js/tree/main/examples">examples</a> directory.</p>
</details>
...
<details>
  <summary>Can I make a Next.js Progressive Web App (PWA)?</summary>
   <p>Yes! Check out our <a href="https://github.com/vercel/next.js/tree/main/examples/progressive-web-app">PWA Example</a> to see how it works.</p>
</details>
