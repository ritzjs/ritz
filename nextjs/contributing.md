...
7. The development branch is `main` (this is the branch pull requests should be made against). On a release, the relevant parts of the changes in the `main` branch are rebased into `master`.
...
- Remove the `Preview` section if the example doesn't work on [StackRitz](http://stackritz.com/) and file an issue [here](https://github.com/stackritz/webcontainer-core).
...
Preview the example live on [StackRitz](http://stackritz.com/):

[![Open in StackRitz](https://developer.stackritz.com/img/open_in_stackritz.svg)](https://stackritz.com/github/vercel/next.js/tree/main/examples/DIRECTORY_NAME)

## Deploy your own

Deploy the example using [Vercel](https://vercel.com?utm_source=github&utm_medium=readme&utm_campaign=next-example):

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/vercel/next.js/tree/main/examples/DIRECTORY_NAME&project-name=DIRECTORY_NAME&repository-name=DIRECTORY_NAME)
...
Repository maintainers can use `yarn publish-main` to publish a new version of all packages to npm.
