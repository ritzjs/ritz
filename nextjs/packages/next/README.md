...
<p align="center">
  ...
  <a aria-label="License" href="https://github.com/vercel/next.js/blob/main/license.md">
...
Our [Code of Conduct](https://github.com/vercel/next.js/blob/main/CODE_OF_CONDUCT.md) applies to all Next.js community channels.
