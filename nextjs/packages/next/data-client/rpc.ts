...
const debug = require('debug')('ritz:rpc')
      ...
      .then(async (response) => {
        ...
        if (response.headers) {
          ...
          if (response.headers.get(HEADER_SESSION_REVOKED)) {
            ...
            setTimeout(async () => {
              // Do these in the next tick to prevent various bugs like https://github.com/ritz-js/ritz/issues/2207
              ...
              // Ref: https://github.com/ritz-js/ritz/issues/1935
            }, 100)
          }
