...
export type RitzPageContext = NextPageContext
...
export interface RitzApiRequest extends NextApiRequest {}
...
export type RitzApiResponse<T = any> = NextApiResponse<T>
...
export type RitzApiHandler<T = any> = NextApiHandler<T>
...
export interface MiddlewareResponse<C = Ctx> extends NextApiResponse {
  /**
   * This will be passed as the second argument to Ritz queries/mutations.
   *
   * You must set ritzCtx BEFORE calling next()
   */
  ritzCtx: C
  /**
   * This is the exact result returned from the Ritz query/mutation
   *
