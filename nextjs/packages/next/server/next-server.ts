...
export type ServerConstructor = {
  ...
  quiet?: boolean
  /**
   * Object what you would use in ritz.config.js - @default {}
   */
...
export default class Server {
  ...
  public constructor({
    ...
    process.env.__RITZ_SESSION_COOKIE_PREFIX = sessionCookiePrefix
  }
  ...
  protected getCustomRoutes(): CustomRoutes {
    ...
    // returned in ritz.config.js so massage them into
