...
import { PageConfig, PreviewData } from '../types/index'
...
import { prettyMs } from './lib/utils'
...
export async function apiResolver(
  ...
  { route, config: ritzConfig }: ApiResolverCtx
): Promise<void> {
  ...
  return async (req, res, next) => {
    ...
    if (req.method === 'HEAD') {
      ...
      try {
        ...
        // TODO FIX TYPE
        const result = await resolver(data, (res as any).ritzCtx)
