...
> {
  ...
  render() {
    ...
    if (
      ...
      children = this.makeStylesheetInert(children) as any /* ritz */
    }

    children = this.handleDocumentScriptLoaderItems(children) as any /* ritz */
...
export class RitzScript extends NextScript {}
