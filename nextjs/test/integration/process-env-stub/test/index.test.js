...
describe('process.env stubbing', () => {
  describe('dev mode', () => {
    ...
    describe('server side', () => {
      ...
      it('should not show missing env value when its not missing ritz public', async () => {
        await checkMissing('/not-missing-ritz', 'RITZ_PUBLIC_HI')
      })
    ...
    describe('client side', () => {
      ...
      it('should not show missing env value when its not missing ritz public', async () => {
        await checkMissingClient('/not-missing-ritz', 'RITZ_PUBLIC_HI')
      })
