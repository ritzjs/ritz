    ...
    describe(
      ...
      () => {
        ...
        it('should not deviate from snapshot', async () => {
          ...
          const ritzExtra = 38
          const ritzExtraGz = 10.2
          expect(parseFloat(indexFirstLoad)).toBeCloseTo(
            gz ? 64 + ritzExtraGz : 196 + ritzExtra,
            0
          )
          ...
          expect(parseFloat(err404FirstLoad)).toBeCloseTo(
            gz ? 66.9 + ritzExtraGz : 204 + ritzExtra,
            0
          )
          expect(err404FirstLoad.endsWith('kB')).toBe(true)

          expect(parseFloat(sharedByAll)).toBeCloseTo(
            gz ? 63.7 + ritzExtraGz : 195 + ritzExtra + 1,
            0
          )
          ...
          const ritzMainExtra = 25
          const ritzMainExtraGz = 7.2
          expect(parseFloat(mainSize)).toBeCloseTo(
            gz ? 20.1 + ritzMainExtraGz : 62.8 + ritzMainExtra,
            0
          )
          expect(mainSize.endsWith('kB')).toBe(true)

          const ritzFrameworkExtra = 13
          const ritzFrameworkExtraGz = 3.2
          expect(parseFloat(frameworkSize)).toBeCloseTo(
            gz ? 42.0 + ritzFrameworkExtraGz : 130 + ritzFrameworkExtra,
            0
          )
