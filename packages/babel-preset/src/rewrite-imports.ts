...
const defaultImportSource = '@ritzjs/core';
...
const specialImports: Record<string, string> = {
  ...
  Head: '@ritzjs/core/head',

  App: '@ritzjs/core/app',

  dynamic: '@ritzjs/core/dynamic',
  noSSR: '@ritzjs/core/dynamic',

  getConfig: '@ritzjs/core/config',
  setConfig: '@ritzjs/core/config',

  resolver: '@ritzjs/core/server',
};
