import { RouterContext, RitzRouter, RitzProvider } from "ritz"
...
export const mockRouter: RitzRouter =     {
  basePath: "",
  pathname: "/",
  route: "/",
  asPath: "/",
...
type RenderOptions = DefaultParams[1] & { router?: Partial<RitzRouter>, dehydratedState?: unknown }

type DefaultHookParams = Parameters<typeof defaultRenderHook>
type RenderHook = DefaultHookParams[0]
type RenderHookOptions = DefaultHookParams[1] & { router?: Partial<RitzRouter>, dehydratedState?: unknown }
