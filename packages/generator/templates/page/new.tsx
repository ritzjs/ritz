if (process.env.parentModel) {
  import {Link, useRouter, useMutation, useParam, RitzPage, Routes} from "ritz"
} else {
  import {Link, useRouter, useMutation, RitzPage, Routes} from "ritz"
}
...
const New__ModelName__Page: RitzPage = () => {
