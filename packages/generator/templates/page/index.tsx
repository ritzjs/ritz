...
if (process.env.parentModel) {
  import {Head, Link, usePaginatedQuery, useRouter, useParam, RitzPage, Routes} from "ritz"
} else {
  import {Head, Link, usePaginatedQuery, useRouter, RitzPage, Routes} from "ritz"
}
...
const __ModelNames__Page: RitzPage = () => {
  if (process.env.parentModel) {
    const __parentModelId__ = useParam("__parentModelId__", "number")
  }
