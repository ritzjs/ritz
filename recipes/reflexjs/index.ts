...
export default RecipeBuilder()
  ...
  .addTransformFilesStep({
    ...
    explanation:
      "Finally, update the Babel configuration to use the Reflfexjs preset. This automatically sets the jsx pragma in your Ritz app so you won't need to import it in your files.",
