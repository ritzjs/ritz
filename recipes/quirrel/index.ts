import {paths, RecipeBuilder} from "@ritzjs/installer"
...
export default RecipeBuilder()
  ...
  .addAddDependenciesStep({
    ...
    explanation:
      "Installs the Quirrel NPM package and concurrently (useful for starting Quirrel together with Ritz).",
    packages: [
      {
        name: "quirrel",
        version: "latest",
  ...
  .addTransformFilesStep({
    stepId: "startWithRitz",
    stepName: 'Start Quirrel with "ritz dev"',
