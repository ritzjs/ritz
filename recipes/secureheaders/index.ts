import {addImport, findModuleExportsExpressions, paths, RecipeBuilder} from "@ritzjs/installer"
...
export default RecipeBuilder()
  ...
  .setDescription(
    `Improve the security of your ritz app at the push of a button. You will probably have to manually adjust your content security policies to suit your needs.`,
  )
  ...
  .addTransformFilesStep({
    ...
    explanation: `Insert custom headers into ritz.config.js and disable the "X-Powered-By: Next.js" header`,
