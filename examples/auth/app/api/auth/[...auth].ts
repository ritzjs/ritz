import {passportAuth, PublicData} from "ritz"
import db from "db"
      ...
      strategy: new TwitterStrategy(
        {
          ...
          callbackURL:
            process.env.NODE_ENV === "production"
              ? "https://auth-example-ritzjs.ritzjs.vercel.app/api/auth/twitter/callback"
      ...
      strategy: new GitHubStrategy(
        {
          ...
          callbackURL:
            process.env.NODE_ENV === "production"
              ? "https://auth-example-ritzjs.ritzjs.vercel.app/api/auth/github/callback"
      ...
      strategy: new Auth0Strategy(
        {
          ...
          callbackURL:
            process.env.NODE_ENV === "production"
              ? "https://auth-example-ritzjs.ritzjs.vercel.app/api/auth/auth0/callback"
