import {Head, Link} from "ritz"
const modelSnippet = `model Project {
  id      Int      @default(autoincrement()) @id
  name    String
}`
const migrateSnippet = `$ ritz prisma migrate dev
  ...
  <div className="container">
    ...
    <main>
      ...
      <div className="buttons">
        <a
          className="button"
          href="https://github.com/ritz-js/ritz/blob/master/USER_GUIDE.md?utm_source=ritz-new&utm_medium=app-template&utm_campaign=ritz-new"
          target="_blank"
